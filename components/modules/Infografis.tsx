  ...
  <div>
    ...
    <div className="relative">
      <select
        ...
        className={`w-full p-2.5 text-xs rounded-lg border appearance-none outline-none focus:ring-2 focus:ring-opacity-50 transition-all font-medium ${isDarkMode
...
const TabButton = ({ active, label, onClick, icon: Icon }: any) => (
  <button
    onClick={onClick}
    className={`flex-1 py-2 px-3 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-2 ${active
    ...
    <div className="space-y-6 animate-fade-in font-sans pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-4 bg-white dark:bg-gray-800 p-6 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm relative overflow-hidden">
        ...
        <button
          ...
          className={`relative px-5 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition-all duration-300 shadow-sm hover:shadow-md z-10 ${isWeatherMode
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold text-white shadow-lg flex items-center justify-center gap-2 transition-all transform active:scale-95 ${isProcessing
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <button
            ...
            className={`w-full py-5 rounded-2xl font-black text-lg shadow-xl flex items-center justify-center gap-3 transition-all transform active:scale-[0.99] group ${isGeneratingImage
